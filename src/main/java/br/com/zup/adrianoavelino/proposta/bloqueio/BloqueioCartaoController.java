...
public class BloqueioCartaoController {
    ...
    public ResponseEntity<Object> cadastrar(@PathVariable String numeroCartao,
        ...
        Cartao cartao = cartaoRepository
                ...
                .orElseThrow(() -> {
                    logger.info("Cartão número {} não encontrado", numeroCartao);
        ...
        if (bloqueioCartaoRepository.existsByCartaoNumeroCartao(numeroCartao)) {
            logger.info("Cartão id={} já está bloqueado", cartao.getId());
        ...
        logger.info("Cartão id={} bloqueado com sucesso!", cartao.getId());
